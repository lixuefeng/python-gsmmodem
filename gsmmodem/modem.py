...
import sys, re, logging, weakref, time, threading, abc, codecs, os
...
class GsmModem(SerialComms):
    ...
    def __init__(self, port, baudrate=115200, incomingCallCallbackFunc=None, smsReceivedCallbackFunc=None, smsStatusReportCallback=None, logPath='/home/pi'):
        ...
        self.log = logging.getLogger('gsmmodem.modem.GsmModem')
    ...
    def hangup(self, callId):
        self.activeCalls[callId].hangup()
        self._handleCallEnded(None, callId)
    ...
    def __threadedHandleModemNotification(self, lines):
        ...
        :param lines The lines that were read
        """
        # for sim7600 will need this line
    ...
    def Wait(self):
        while True:
            self.log.info('signal strength: %s', self.signalStrength)
            time.sleep(60)
